...
- **Sessão 59 (28/06/2026) — Início da migração planilha → Postgres (unificação c/ Dashboard):**
  ...
  - **Progresso prod:** Próximo na ordem: Pinnacle, Superbet + casas inativas restantes (Novibet, etc.). Bet365 ATIVAS (gleice/marlon/Talia) pendentes. Base do operador: CSV separado, depois. **Padrão: selecionar por (casa,parceiro), validar stake/PL+colisão, normalizar typos de parceiro ([ Eu]→[Eu]). Arquivo fonte atual: CSV(7).**
