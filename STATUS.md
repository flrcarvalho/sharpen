...
- **Sessão 59 (28/06/2026) — Início da migração planilha → Postgres (unificação c/ Dashboard):**
  ...
  - **Progresso prod:** Próximo na ordem: Pinnacle (ativas+arquivadas), Superbet, Betnacional + casas inativas restantes (Novibet, KingPanda?, etc.). Bet365 ATIVAS (gleice/marlon/Talia) pendentes (era recente). Base do operador: CSV separado, depois. **Padrão de seleção: sempre por (casa,parceiro), validar stake/PL e colisão antes de gravar.**
