...
|---|---|---|---|
| **Sessões 327 → 300** | [`historico/HISTORICO_s300-s327.md`](historico/HISTORICO_s300-s327.md) | 197 KB | Os blocos completos que saíram do `STATUS.md` (327 → 317), a Sessão 315 e a cadeia `_Anterior_` de 324 até 300. |
