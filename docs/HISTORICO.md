...
|---|---|---|---|
| **Sessões 357 → 300** | [`historico/HISTORICO_s300-s327.md`](historico/HISTORICO_s300-s327.md) | 336 KB | Os blocos completos que saíram do `STATUS.md` (358, 357, 356, 354 e 353; 339 e 336 → 317), a Sessão 315 e a cadeia `_Anterior_` de 339 até 300. |
