    ...
    <div class="analise-popup-overlay" id="apEditOverlay" onclick="fecharEdicaoApostas(event)">
      <div class="analise-popup-modal" id="apEditModal" style="max-width:560px" onclick="event.stopPropagation()">
        ...
        <div style="padding:var(--sp-5) var(--sp-6);display:grid;grid-template-columns:1fr 1fr;gap:12px 14px">
          <div class="apedit-field"><label class="apedit-label" for="ap-ed-data">Data</label><div class="apedit-data-wrap"><input class="apedit-inp" id="ap-ed-data" type="text" placeholder="DD/MM/AAAA" spellcheck="false" autocomplete="off"><button type="button" class="apedit-data-btn" title="Abrir calendário" aria-label="Abrir calendário" onclick="apEdAbrirCalendario()"><svg width="14" height="14" viewBox="0 0 15 15" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="1.5" y="2.5" width="12" height="11" rx="2"/><path d="M1.5 6.5h12"/><path d="M4.5 1v3"/><path d="M10.5 1v3"/></svg></button><input type="date" id="ap-ed-data-cal" tabindex="-1" aria-hidden="true"></div></div>
