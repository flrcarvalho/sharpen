...
_INSTRUCAO = (
    ...
    "MÚLTIPLA — REGRA ABSOLUTA:\n"
    "  • Bilhete com N seleções = SEMPRE 1 única linha no TSV. NUNCA gere uma linha por seleção.\n"
    "  • Aposta: 'Múltipla'\n"
    "  • Odd: W com PRÊMIO/retorno visível → PRÊMIO ÷ Stake; L ou V → ODDS TOTAIS do bilhete.\n"
    "  • Stake: valor total do campo APOSTA — nunca dividir entre as N seleções.\n"
    "  • Descrição: seleções concatenadas com ' // ' na ordem do bilhete.\n"
    "  • Esporte: se todas as seleções forem do mesmo esporte → esse esporte; senão → 'Múltiplos'.\n\n"
    "## Confiança\n"
